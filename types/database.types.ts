...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      balance_adjustments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "balance_adjustments_approved_by_fkey";
            columns: ["approved_by"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "balance_adjustments_requested_by_fkey";
      ...
      game_public_seq: {
        ...
        Relationships: [
          {
            foreignKeyName: "game_public_seq_game_id_fkey";
            columns: ["game_id"];
            isOneToOne: true;
      ...
      incoming_emails: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_incoming_emails_email_account";
      ...
      problem_cases: {
        Row: {
          ...
          status: Database["public"]["Enums"]["problem_case_status"];
          stock_id: string | null;
          updated_at: string;
        };
        Insert: {
      ...
      products: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_products_product_category";
            columns: ["category_id"];
            isOneToOne: false;
    ...
    Functions: {
      audit_to_uuid: { Args: { p_id: unknown }; Returns: string };
      backfill_inventory_vectors: { Args: never; Returns: number };
      game_code_from_name: { Args: { p_name: string }; Returns: string };
