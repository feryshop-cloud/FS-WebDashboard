            ...
            {totalPages > 1 && (
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="text-muted-foreground hover:bg-muted rounded p-1 transition-colors disabled:opacity-30"
                ...
                <span className="text-faint-foreground text-xs tabular-nums">
                  ({totalFiltered})
                </span>
              </div>
            )}
              ...
              >
                ...
                <div
                  className={`w-40 shrink-0 truncate pr-4 text-sm ${
                    email.isRead ? "text-muted-foreground font-medium" : "text-foreground font-bold"
                  }`}
                >
                  {email.sender}
                </div>
