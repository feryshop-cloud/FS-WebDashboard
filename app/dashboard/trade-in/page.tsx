  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-6 pb-8">
      ...
      <div className="grid grid-cols-1 gap-4">
        {isLoading ? (
          <div className="flex justify-center rounded-xl border border-slate-100 bg-white p-12 shadow-sm">
            <Loader2 className="h-8 w-8 animate-spin text-blue-600" />
          </div>
        ) : deals.length === 0 ? (
          <div className="rounded-xl border border-slate-100 bg-white p-12 text-center text-sm text-slate-500 shadow-sm">
          ...
          deals.map((tt) => {
            ...
            return (
              ...
              >
                ...
                {/* Card Header */}
                <div className="flex items-center gap-4 border-b border-slate-50/50 bg-slate-50/30 px-6 py-4">
                ...
                <div className="grid grid-cols-1 items-center gap-6 px-6 py-5 lg:grid-cols-12">
                  ...
                  {/* SUMMARY */}
                  <div className="col-span-1 mt-4 flex h-full flex-col items-end justify-center border-t border-slate-100 pt-4 lg:col-span-3 lg:mt-0 lg:border-l lg:border-slate-100 lg:pt-0 lg:pl-6">
      ...
      {deals.length > 0 && (
        <div className="mt-4 flex justify-center">
          <button className="rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-600 shadow-sm transition-colors hover:bg-slate-50">
            Muat Lebih Banyak
          </button>
        </div>
      )}
          ...
          <div className="animate-in slide-in-from-right flex h-full w-full max-w-md flex-col bg-white shadow-2xl duration-300">
            <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-6 py-5">
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">Isi detail aset masuk dan keluar.</p>
              </div>
              <button
            ...
            <form action={handleAddTT} className="flex flex-1 flex-col overflow-hidden">
              <div className="flex-1 space-y-6 overflow-y-auto p-6">
                ...
                <div className="space-y-3">
                  <h3 className="text-xs font-bold tracking-wider text-blue-600 text-slate-400 uppercase">
                ...
                {/* Customer In Section */}
                <div className="space-y-3">
                  <h3 className="text-xs font-bold tracking-wider text-emerald-600 text-slate-400 uppercase">
                ...
                {(priceOut > 0 || ttValue > 0) && (
                  <div
                    className={`rounded-xl border p-4 ${selisih < 0 ? "border-emerald-100 bg-emerald-50" : selisih > 0 ? "border-rose-100 bg-rose-50" : "border-slate-100 bg-slate-50"}`}
                  >
                    <h3 className="mb-2 text-sm font-semibold text-slate-900">Selisih Transaksi</h3>
