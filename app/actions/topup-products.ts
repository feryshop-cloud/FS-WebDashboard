...
export async function getTopupProducts() {
  ...
  if (error) {
    console.error("Error fetching topup products:", error);
...
export async function addTopupProduct(input: TopupProductInput) {
  ...
  if (error) {
    console.error("Database Error creating topup product:", error);
...
export async function updateTopupProduct(id: string, input: TopupProductInput) {
  ...
  if (error) {
    console.error("Database Error updating topup product:", error);
...
export async function deleteTopupProduct(id: string) {
  ...
  if (error) {
    console.error("Database Error deleting topup product:", error);
