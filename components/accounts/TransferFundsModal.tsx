...
import { useTransferFunds } from "@/lib/hooks/features/useTransferFunds";
...
export function TransferFundsModal({ isOpen, onClose, accounts }: TransferFundsModalProps) {
  const {
    ...
    actions: { setSourceId, setDestId, setAmount, setAdminFee, handleSubmit },
  } = useTransferFunds(accounts, isOpen, onClose);
