  ...
  return (
    <div className="space-y-1.5">
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-[10px] border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-sm text-slate-900 transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
      >
        <span className="flex items-center gap-2">
          {value ? (
            ...
            <span className="text-slate-400">Pilih ikon...</span>
          )}
        </span>
        <ChevronDown
      ...
      {open && (
        <div className="max-h-56 overflow-y-auto rounded-[10px] border border-slate-200 bg-white p-2 shadow-sm">
