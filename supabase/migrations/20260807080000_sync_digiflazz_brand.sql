-- Extend sync_digiflazz_products to also write the brand column from the
-- Digiflazz item.brand (e.g. "Mobile Legends", "Free Fire"). Brand is always
-- set on re-sync so it tracks the upstream price list.
--
-- Column was introduced by 20260807070000_products_brand.sql (nullable).
